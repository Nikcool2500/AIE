...
## Общая информация
- **Тип задачи**: Регрессия (прогноз кредитного лимита)
- **Целевая переменная**: `Credit_Limit` — установленный кредитный лимит клиента (число, USD)
- **Примерный объём**: ~10 000 записей, 18 полезных признаков